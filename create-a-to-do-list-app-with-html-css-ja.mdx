...
<AuthorAvatar
  author_name="Tanisha Sharma
  
  username="TanishaSharma20"
  uid={true}
/>
...
We work together to check off every incomplete task on our to-do list using HTML, CSS, and JavaScript. By the end , you'll be able to ADD, DELETE, EDIT, and most importantly COMPLETE tasks.
...
Let's set up our editor. For this application, we will be using our PC terminal and [Visual Studio Code](https://code.visualstudio.com) (VS Code).
